...
average_algs = ['snr', 'sharpness', 'edge_sharpness', 'composite']
#average_algs = ['snr']
sharpening_algs = ['unsharp_mask', 'sharpen', 'sharpen2']
...
def grid_search():
    ...
    for align_alg in align_algs:
        for nfeatures in n_features:
            ...
            save_images(preprocessed, './images/preprocessed', 'png', f'{align_alg}_{nfeatures}', clear = False)
