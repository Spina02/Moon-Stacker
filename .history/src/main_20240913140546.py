...
def image_stacking(features_alg = 'orb', stacking_alg = 'median', average_alg = None, n_features = 5000, denoise = False, denoise_alg = 'gaussian', sigma = 1.5, strength = 3, crop = True):
