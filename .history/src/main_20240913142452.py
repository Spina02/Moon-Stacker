...
def image_stacking(features_alg = 'orb', stacking_alg = 'median', average_alg = None, n_features = 5000, denoise = False, denoise_alg = 'DnCnn', sigma = 1.5, strength = 3, crop = True):
    ...
    # Save the image
    save_image(image, config.output_folder + f'/{features_alg}_{stacking_alg}_{n_features}' + f'_{average_alg}' if stacking_alg == 'weighted average' else '.lower()')
