...
def image_stacking(features_alg = 'orb', stacking_alg = 'median', average_alg = 'snr', n_features = 5000, denoise = False, denoise_alg = 'DnCnn', sigma = 1.5, strength = 3, crop = True):
...
def main():
    #image = read_image('./images/output/orb_sigma clipping_5000_snr.png')

    # save the image
    #save_image(image, './images/output/orb_sigma clipping_5000_gray.png')
    #config_init()

    image_stacking()
    
    # grid search
    #grid_search(crop = IS_MOON)
