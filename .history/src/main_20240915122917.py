...
def image_stacking_2(images, features_alg = 'orb', average_alg = 'composite', ):
    print()

    preprocessed = preprocess_images(images, algo = 'orb', align = True, crop = True, grayscale = False, unsharp = False)
    for strength in [0.8, 0.85, 0.9, 0.95]:
        print(f"unsharping with strength: {strength}")
        unsharped = preprocess_images(images, align = False, crop = False, grayscale = True, unsharp = True, strength = strength)
