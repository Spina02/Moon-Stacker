...
def sobel_images(images):
    ...
    for image in images:
        ...
        # Normalize the result to 0-1 and append to the list
        sobel_images.append(sobel)#normalize(sobel)
    return sobel_images
...
def unsharp_mask(images, model, strength):
    ...
    normalized_sobel_masks = [cv2.normalize(mask, None, 0, 1, cv2.NORM_MINMAX) for mask in sobel_masks]
